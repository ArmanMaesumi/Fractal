...
import { defaultFSText, defaultVSText, floorFSText } from "./Shaders.js";
...
export class MengerAnimation extends CanvasAnimation {
    ...
    initFloor() {
        ...
        const gl = this.ctx;
        /* Compile Shaders */
        this.floorProgram = WebGLUtilities.createProgram(gl, defaultVSText, floorFSText);
    ...
    draw() {
        ...
        // TODO: draw the floor
        /* Menger - Update/Draw */
        const modelMatrixFloor = this.floor.uMatrix();
        gl.useProgram(this.floorProgram);
        this.extVAO.bindVertexArrayOES(this.floorVAO);
        ...
        gl.uniformMatrix4fv(this.floorWorldUniformLocation, false, new Float32Array(modelMatrixFloor.all()));
        ...
        // console.log("Drawing ", this.floor.indicesFlat().length, " triangles (floor)");
